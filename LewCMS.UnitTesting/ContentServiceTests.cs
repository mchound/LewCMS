...
namespace LewCMS.UnitTesting
{
    ...
    //        ServicesTestHelper.Instance.SetContentCacheService(new ContentCacheService());
    //        ServicesTestHelper.Instance.SetContentRepository(new ContentRepository(ServicesTestHelper.Instance.InitializeService, ServicesTestHelper.Instance.ContentCacheService, new LewCMSJsonSerializer(), ContentServiceTests.FILE_PERSIST_PATH));
    //        ServicesTestHelper.Instance.SetContentService(new ContentService(ServicesTestHelper.Instance.ContentRepository));

    //        var contentService = ServicesTestHelper.Instance.ContentService;
