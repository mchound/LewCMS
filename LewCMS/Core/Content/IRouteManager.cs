...
namespace LewCMS.Core.Content
{
    ...
    public class RouteManager : IRouteManager
    {
        ...
        {
            string parentRoute = string.IsNullOrWhiteSpace(parentId) ? string.Empty : this._contentRepository.GetPageInfoFor(pi => pi.PageId == parentId).PageRoute;
        ...
        {
            IEnumerable<IPageInfo> pagesMetaData = this._contentRepository.GetPageInfo(pi => pi.PageRoute.ToLower() == route.ToLower() && pi.PageId != pageId);
